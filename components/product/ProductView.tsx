...
import { REVIEWS, SLOT } from '@/lib/data';
          ...
          <div className="stack g8 sticky">
            ...
            <Accordion
              items={[
                ...
                [
                  'Specification',
                  `Net quantity ${p.netQuantity}. SKU ${p.sku}. Grade [GRADE]. Lot [LOT-0000], plucked [MONTH 0000]. Packed at source in a lined steel tin. Ingredients: ${p.ingredients}. FSSAI Lic. No. [00000000000000].`,
                ],
                [
